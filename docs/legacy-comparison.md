...
CMHS SangerFlow Pipeline was developed as an independent implementation after evaluating laboratory
...
CMHS SangerFlow Pipeline replaces the core chromatogram workflow with ABI parsing, quality trimming,
...
CMHS SangerFlow Pipeline is not a command-line-compatible replacement for ASAP. In particular, automatic
